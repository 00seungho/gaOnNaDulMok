    ...
    var searchjson = function (url, busName) {
        fetch(url)
            ...
            .then(data => {
                ...
                searchfind(`https://hifive.metainsu.co.kr/api/v1/common/busBus/?stid=${data[a].NODE_ID}&serverkey=NiGhn1xzYgu3Jk2dfWcsdseqg0Iufba%2FpRhl0nHbuNsDK8poZ0xTKBgyTNO0mzWieKL4TtLgCY0oTGD15kFlWw%3D%3D`);
                searchfind2(`https://hifive.metainsu.co.kr/api/v1/common/busBus/?stid=${data[c].NODE_ID}&serverkey=NiGhn1xzYgu3Jk2dfWcsdseqg0Iufba%2FpRhl0nHbuNsDK8poZ0xTKBgyTNO0mzWieKL4TtLgCY0oTGD15kFlWw%3D%3D`);
                newmarker(a, data);
                newmarker2(c, data);
            })
    }
                ...
                if (typeof (dataItem) != "string") {
                    if (Array.isArray(dataItem.itemList)) {
                        ...
                        for (var i = 0; i < dataItem.itemList.length; i++) {
                            if (dataItem.itemList[i].arrmsg1 == "운행종료" || dataItem.itemList[i].arrmsg1 == "출발대기") {
                                firstfound.innerHTML += "<h2>버스 이름: " + dataItem.itemList[i].busRouteAbrv + "</h2>" //버스명 먼저출력
                                firstfound.innerHTML += "<h3>운행 종료</h3>"
                                firstfoundmobile.innerHTML += "<h2>버스 이름: " + dataItem.itemList[i].busRouteAbrv + "</h2>" //버스명 먼저출력
                                firstfoundmobile.innerHTML += "<h3>운행 종료</h3>"
                            }
                        ...
                        if (dataItem.itemList.arrmsg1 == "운행종료" || dataItem.itemList.arrmsg1 == "출발대기") {
                    ...
                    if (Array.isArray(dataItem.itemList)) {
                        for (var i = 0; i < dataItem.itemList.length; i++) {
                            if (dataItem.itemList[i].arrmsg1 == "운행종료" || dataItem.itemList[i].arrmsg1 == "출발대기") {
                                ...
                                twofound.innerHTML += "<h3>운행 종료</h3>"
